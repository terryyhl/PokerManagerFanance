...
export default function BottomNav() {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#151f2b] border-t border-slate-200 dark:border-slate-800 flex items-center justify-around px-2 z-50 pt-2 pb-2">
            {tabs.map((tab) => {
