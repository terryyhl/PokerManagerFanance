...
export default function BottomNav() {
    ...
    return (
        <div className="fixed left-0 right-0 bg-white dark:bg-[#151f2b] border-t border-slate-200 dark:border-slate-800 flex items-center justify-around px-2 z-50 pt-2 pb-2" style={{ bottom: 'calc(-1 * env(safe-area-inset-bottom, 0px))' }}>
            {tabs.map((tab) => {
