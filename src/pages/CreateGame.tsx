...
export default function CreateGame() {
  ...
  const handleCreate = async () => {
    ...
    if (roomType === 'texas' && (!pointsPerHand || pointsPerHand <= 0)) { setError('每手积分额度必须大于0'); return; }
    if (roomType === 'texas' && (!maxHandsPerBuy || maxHandsPerBuy <= 0)) { setError('单次最大手数必须大于0'); return; }
